...
class Auth extends CI_Controller {
		...
		if ($this->form_validation->run() == true)
		{
			...
			if ($this->ion_auth->login($this->input->post('email'), $this->input->post('password'), $remember))
			{
				...
				//redirect them back to the home page
                            $usuario = $this->ion_auth->user($this->session->userdata('user_id'))->row();
                            $this->ion_auth_model->set_session($usuario);
		...
		else
		{
			...
			$this->data['password'] = array('name' => 'password',
				...
				'type' => 'password',
                        ...
                        $this->data['submit'] = array('name' => 'enviar',
	...
	function create_user()
	{
		...
		$this->form_validation->set_rules('rut', $this->lang->line('create_user_validation_rut_label'), 'required|xss_clean|callback_rut_check');
		$this->form_validation->set_rules('password', $this->lang->line('create_user_validation_password_label'), 'required|min_length[' . $this->config->item('min_password_length', 'ion_auth') . ']|max_length[' . $this->config->item('max_password_length', 'ion_auth') . ']|matches[password_confirm]');
		$this->form_validation->set_rules('password_confirm', $this->lang->line('create_user_validation_password_confirm_label'), 'required');
                $this->form_validation->set_rules('groups', $this->lang->line('edit_user_validation_groups_label'), 'required|xss_clean');
		...
		else
		{
			...
			$this->data['rut'] = array(
				...
				'id'    => 'rut',
                            ...
                            'placeholder' => 'Rut',
				'type'  => 'text',
				'value' => $this->form_validation->set_value('rut'),
			);
			...
			$this->data['password'] = array(
				...
				'value' => $this->form_validation->set_value('password'),
                        ...
                        $this->data['grp'] = $this->form_validation->set_value('groups');
        ...
        function rut_check($rut)
        {
                    ...
                    return true;
                        ...
                        $this->form_validation->set_message('rut_check', 'El rut es incorrecto');
                    return false;
                    }
	...
	function edit_user($id)
	{
		...
		$this->form_validation->set_rules('rut', $this->lang->line('edit_user_validation_rut_label'), 'required|xss_clean');
