  ...
  <div class="row-fluid">
    ...
    <div class="span10">
        ...
        <table id="tabla" class="table table-hover table-bordered">
            <thead>   <tr><th>ID Indicador</th><th>Nombre</th><th>Entorno</th> <th width='50'>Acciones</th></tr>  </thead>
            <tbody><?php if($indicadores){?>
            <?php foreach ($indicadores->result() as $indicador){
            echo '<tr id="tr'.$indicador->idindicador.'"><td>'.$indicador->idindicador.'</td><td>'.$indicador->nombre.'</td><td>'.$indicador->entorno.'</td><td>
                    <a class="editar"  data-toggle="tooltip" title="Editar" titulo="editar" href="" id="'.$indicador->idindicador.'"><i class="icon-edit"></i></a>&nbsp;
                <a class="eliminar"  data-toggle="tooltip" title="Eliminar"  titulo="eliminar"  href="" id="'.$indicador->idindicador.'" ><i class="icon-remove"></i></a></td></tr>';
            }}?>
            </tbody>
        </table>
...
<div class="modal-header">
    ...
    <h3 id="myModalLabel">Indicadores</h3>
  </div>
  <div id="crearBody" class="modal-body">
         <p class="text-success">Crear nuevo indicador</p>
                  <hr/>
        <form class="form-horizontal" method="post" id="form-crear" name="form-crear">
            <fieldset>
                ...
                <div id="identorno-crear-v" class="control-group">
...
<div id="editarBody" class="modal-body">
     <p class="text-warning">Modificar indicador</p>
                 <hr/> 
   <form id="form-editar" method="post" name="form-editar" class="form-horizontal">
        <fieldset>
              ...
              <div id="identorno-editar-v" class="control-group">
                    <label class="control-label">Nombre:</label>
                    <div class="controls">
                      <select name = "identorno" id = "identorno" >
                        <?php foreach($entornos->result() as $entorno){?>
        ...
        <div id="eliminarBody" class="modal-body">
          ...
          <form id="form-eliminar" method="post" name="form-eliminar" class="form-horizontal">
              <fieldset>        
                 ...
                 <div  id="entorno-eliminar-v"  class="control-group">
                     <labe class="control-label">Entorno</labe>
                     <div class="controls">
                       <input type="text" value="" name="entorno" id="entorno" disabled />
                     </div>
                 </div>
                 <div class="control-group">
                     <div class="controls">     
